...
import 'editor/basic_text_field.dart';
import 'editor/replacements.dart';
import 'editor/text_editing_delta_history_manager.dart';
import 'editor/toggle_buttons_state_manager.dart';


/// 위아래 이동시 포지션 불안... 아직 미 완성 에디터, 플로터 갈길이 멀다.
class MessageFieldEditor extends StatefulWidget {
  const MessageFieldEditor({Key? key}) : super(key: key);

  @override
  State<MessageFieldEditor> createState() => _MessageFieldEditorState();
}

class _MessageFieldEditorState extends State<MessageFieldEditor> {
